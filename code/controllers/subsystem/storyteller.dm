...
/datum/controller/subsystem/gamemode/proc/refresh_alive_stats(roundstart = FALSE)
	...
	for(var/client/client in GLOB.clients)
		...
		if(ishuman(living))
			...
			if((human_mob.mind.assigned_role in GLOB.burgher_positions) || (human_mob.mind.assigned_role in GLOB.peasant_positions) || (human_mob.mind.assigned_role in GLOB.mercenary_positions))
