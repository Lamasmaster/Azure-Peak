...
/obj/item/clothing/head/roguetown/helmet/kettle/slittled
...
/obj/item/clothing/head/roguetown/helmet/kettle/slittled/attackby(obj/item/W, mob/living/user, params)
	..()
